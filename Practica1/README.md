...
- EL usuario cliente puedecancelar sus ordenes. 
- El restaurante debe poder visualizar las ordenes creadas por los clientes, seleccionarla para marcarla como EN PROCESO y despues de completamla marcarla como FINALIZADA/LISTA para etrega.
...
- A su vez cuando el restaurante rechace una orden debe notificarle al clietnte por un correo, mastrando la información: Nombre del restaurante, número de orden, productos ordenados,estado actual de la orden (EN CAMINO).
