...
-- PAGOS DATABASE
CREATE DATABASE Delivereats_SA_Pagos;
GO
USE Delivereats_SA_Pagos;
GO
CREATE TABLE Pagos (
    Id INT PRIMARY KEY IDENTITY(1,1),
    OrdenId INT NOT NULL,
    ...
    Estado NVARCHAR(32) NOT NULL DEFAULT 'PAGADO', --PAGADO, REEMBOLSADO
    UsaCupon BIT NOT NULL,
    MetodoPago NVARCHAR(32) DEFAULT 'TARJETA',
    Moneda NVARCHAR(8) DEFAULT 'USD',
    CONSTRAINT UQ_Pago_Orden UNIQUE (OrdenId),
