...
func (c *CatalogClient) GetCatalog(restaurantID int32) (*catalogpb.GetCatalogResponse, error) {

	ctx, cancel := context.WithTimeout(context.Background(), 5*time.Second)
	defer cancel()

	return c.client.GetCatalogByRestaurant(ctx, &catalogpb.GetCatalogRequest{
